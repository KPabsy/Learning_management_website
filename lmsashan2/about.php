    ...
    <div class="profile-section">
        <div class="profile-header">
            ...
            <div class="profile-info">
                ...
                <p class="profile-tagline">Empowering students through quality mathematics education</p>
            </div>
        </div>
        ...
        <div class="profile-content">
            <div class="about-text">
                <h3>About Me</h3>
                <p>Welcome to my mathematics tutoring platform! I am Ashan Sudusinghe, a dedicated mathematics educator with a passion for helping students excel in their mathematical journey.</p>
                
                <p>With years of experience in teaching mathematics at various levels, I specialize in making complex mathematical concepts simple and understandable for students. My teaching approach focuses on building strong foundations and developing problem-solving skills that will benefit students throughout their academic careers.</p>
                
                <p>I believe that every student has the potential to succeed in mathematics with the right guidance and support. My goal is to create a positive learning environment where students feel confident to ask questions and explore mathematical concepts at their own pace.</p>
            </div>
